...
import utils
from djangoorm import load_djangoorm, models, settings, nicegui_settings

load_dotenv()
load_djangoorm()


# todo: 2025-07-15-15:00，暂停前端 nicegui、tailwind 等学习，开始深入 django。过几天继续前端时，推荐直接找实例视频！
#       参考资料：
#       1.【tailwind前端框架实战】用全新的前端框架tailwind做一个github页面，能加快300%写代码的速度，前端程序员必看：https://www.bilibili.com/video/BV1rf4y1g7r5
#       2. 2021 Tailwind CSS 中文教程：https://www.bilibili.com/video/BV1wA411g7yf
#       3. 随心所欲的UI库 | Shadcn快速上手：https://www.bilibili.com/video/BV1ye411v7Q2
#       4. TailwindCSS 中文文档：https://www.tailwindcss.cn/docs/installation
#       5. NiceGUI 简介 - vision 0.0.5 文档：https://visionz.readthedocs.io/zh-cn/latest/ext/nicegui/intro.html
#       6. Quasar：https://quasar.dev/vue-components/spinners#qspinner-api | https://quasar.nodejs.cn/start/quick-start
#       7. NiceGUI：https://nicegui.io/#examples | https://nicegui.io/documentation/spinner
#       8. Tabulator：https://tabulator.info/
#       9. QCalendar：https://quasarframework.github.io/quasar-ui-qcalendar/docs
#       10. Quasar Table：https://quasar.dev/vue-components/table
#       11. ex4nicegui - 基于 nicegui 创建的响应式扩展库：https://gitee.com/carson_add/ex4nicegui
#       12. 快速上手 Apache ECharts：https://echarts.apache.org/handbook/zh/get-started/
#       13. nicegui source code：https://github.com/zauberzeug/nicegui/blob/main/examples/authentication/main.py
#       14. Font Awesome：https://fontawesome.com/search?q=eye&o=r（Quasar docs 有更多链接）
#       15：OneTab: https://www.one-tab.com/page/1L8GSqhVRjuP8MUZajibBw
#                   https://www.one-tab.com/page/JATh4zDKSj-92RWKaka3yQ
#       16. 注意 frontend/examples/*.py 中的一些例子（源自 NiceGUI 中文文档）
#       17. PyInstaller Manual：https://pyinstaller.org/en/stable/
#       18. 数据大宇宙：https://www.bilibili.com/video/BV1HK411e7kg
#                      https://www.bilibili.com/video/BV1dz4y1N7oe
#                      https://space.bilibili.com/407045226
#                      https://www.bilibili.com/video/BV1y5411e7qK
#       19. CSS 简介：https://www.runoob.com/css/css-intro.html
#       20. CSS：层叠样式表：https://developer.mozilla.org/zh-CN/docs/Web/CSS
#       21. CSS教程：https://geek-docs.com/css/css-top-articles/1000100_index.html
#       22. 网站原型图怎么做？保姆级教程！：https://pixso.cn/designskills/websiteprototype/
#       23. FastAPI 教程：https://www.runoob.com/fastapi/fastapi-tutorial.html
#       24. FastAPI：https://fastapi.tiangolo.com/ | https://fastapi.tiangolo.com/zh/ | https://fastapi.org.cn/
#       25. myqcloud 是什么，file.myqcloud.com：https://cloud.tencent.cn/developer/information/file.myqcloud.com-ask
#       26. JavaScript 教程：https://wangdoc.com/javascript/


def init_logger():
    # 配置日志记录器（generated by deepseek）
    logger.configure(
        handlers=[
            # 控制台输出（带颜色）
            {
                ...
                # noqa: PEP 8: E501 line too long (196 > 120 characters)
                "level": "DEBUG",
                "colorize": True
            },
            # 文件输出（带时间轮转）
            {
                "sink": str(settings.ROOT_DIR / "logs" / "app_{time:YYYY-MM-DD}.log"),
            ...
            # 错误日志单独保存（可选）
            {
                "sink": str(settings.ROOT_DIR / "logs" / "error_{time:YYYY-MM-DD}.log"),
                "format": "{time:YYYY-MM-DD HH:mm:ss.SSS} | {level: <8} | {name}:{function}:{line} - {message}",
                "level": "WARNING",
...
class Helper:
    ...
    def get_update_log_mardown_files():  # todo:  -> Generator[str] 如何使用？
        ...
        markdown_dir = nicegui_settings.STATIC_DIR / "markdown"
...
class View:
    class _create_header_element(ui.header):  # noqa: Class names should use CapWords convention
        def __init__(self,
            ...
            with self.classes("flex flex-col p-0 gap-0 bg-green-500 dark:bg-green-900"):
                with ui.row().classes("w-full items-center justify-between px-4 py-2 text-white"):
                    # 左侧：图标和标题
                ...
                with ui.row().classes("w-full text-white"):
    ...
    class _create_markdown_tab_panel(ui.tab_panel):  # noqa: Class names should use CapWords convention
        ...
        def _read_markdown_file(relative_path: str) -> str:
            filepath = nicegui_settings.STATIC_DIR / "markdown" / relative_path
